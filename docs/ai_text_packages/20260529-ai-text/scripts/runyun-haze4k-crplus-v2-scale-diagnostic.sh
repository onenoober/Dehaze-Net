...
CODE_DIR="$ROOT/code"
CHECKPOINT="${CHECKPOINT:-$ROOT/experiment/HAZE4K/DEA-Net-CR-H4K-Baseline-scout-20260520-101334/saved_model/best.pk}"
MODEL_LABEL="${MODEL_LABEL:-DEA-Net-CR-baseline}"
SPLIT="${SPLIT:-train}"
MAX_IMAGES="${MAX_IMAGES:-256}"
PATCH_SIZE="${PATCH_SIZE:-256}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/experiment/HAZE4K/loss_scale/crplus-v2-baseline-${SPLIT}${MAX_IMAGES}-$(date +%Y%m%d)}"
...
CANDIDATE_WEIGHTS="${CANDIDATE_WEIGHTS:-0.005,0.01,0.03,0.05,0.1}"
