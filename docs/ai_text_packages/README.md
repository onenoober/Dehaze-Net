...
| `20260530-strong-official-depth-safety-audit/` | Focused text-only Strong-Official Depth Safety Audit package with audit code, launch script, route docs, compact log, JSON/CSV/MD outputs, and the small official-candidate-depth join. Start at `20260530-strong-official-depth-safety-audit/PACKAGE_README.md`. |
