...
| `experiment/HAZE4K/DEA-Net-LFCR-v1-w005-H4K-scout100k-20260527-231728` | active LFCR-v1 fair scout | runyun fair 100k scout launched from `codex/haze4k-lfcr-v1` commit `1a32a2a`; LF-v1 architecture plus `w_loss_crplus_v2=0.005`; gate decisions should use PSNR/SSIM, LF-v1 regression rescue, strong-baseline risk, residual diagnostics, LF gate activity, and CRPlus-v2 scale/frequency metrics | `PENDING_ACTIVE` |
