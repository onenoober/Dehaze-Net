...
| `DEA-Net-CBRFRC-v1-H4K-scout100k-20260530-012811` | active remote | active AutoDL CBRFRC-v1 fair scout | no 10k checkpoint yet | launched on `autodl-dehaze` from `/root/autodl-tmp/workspace/Dehaze-Net`, branch/commit `codex/haze4k-cbrfrc-v1` / `4634b13`, tmux `cbrfrc_v1_100k`, after zero-gate identity, bounded-oracle, and fixed-patch micro-overfit passed under the approved safety config. Fair protocol `epochs=20`, `iters_per_epoch=5000`, total `100000`, `bs=16`, `patch_size=256`, `w_loss_L1=1.0`, `w_loss_CR=0.1`, checkpoint/eval every `10000`, `save_epoch_checkpoints=false`; frozen CR J0 with `brf_preserve_warmup_steps=3000` and `brf_preserve_gate_weight=0.0`; next decision is the 10k mechanism sanity gate | `KEEP_ACTIVE_REMOTE_MODEL` |
...
| `experiment/HAZE4K/DEA-Net-CBRFRC-v1-H4K-scout100k-20260530-012811` | active AutoDL CBRFRC-v1 fair scout | remote AutoDL run launched only after the CBRFRC safety line passed; branch/commit `codex/haze4k-cbrfrc-v1` / `4634b13`; tmux `cbrfrc_v1_100k`; log `experiment/HAZE4K/_run_logs/DEA-Net-CBRFRC-v1-H4K-scout100k-20260530-012811.log`; fair protocol `epochs=20`, `iters_per_epoch=5000`, total `100000`, `bs=16`, `patch_size=256`, `w_loss_L1=1.0`, `w_loss_CR=0.1`, checkpoint/eval every `10000`; frozen CR baseline J0 and approved preserve warmup/gate config. Keep full remote run directory/log/checkpoints; do not sync checkpoints locally unless explicitly requested; next gate is 10k mechanism sanity | `KEEP_ACTIVE_REMOTE_MODEL` |
