...
| `docs/ai_text_packages/20260530-cbrfrc-v1` | `experiment/dehaze-net-ai-text-pack-20260530-cbrfrc-v1` | Focused CBRFRC-v1 text package; 65 text files, about 1.5 MB uncompressed; implementation files, route docs, preflight CSV/JSON/logs, best-checkpoint diagnostic CSV/JSON, compact 100k training log, args, and validation curve log; excludes checkpoints, TensorBoard, arrays, images, datasets, and the full raw 100k step log. Sync audit on 2026-05-30: source and package file sets both `65`, missing/extra `0/0`; local tracked and remote tracked package files both `65`, missing/extra remote `0/0`; forbidden tracked extensions `0`. | `COMMIT_AND_PUSH_AUDIT_REMOTE` |
