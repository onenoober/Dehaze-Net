...
| `DEA-Net-LFCR-v2-decay-H4K-scout100k-20260528-091455` | remote active | active fair LFCR-v2 decay scout | pending | launched from commit `9009515` in clean remote checkout `/root/workspace/Dehaze-Net-audit-sync` on branch `codex/haze4k-lfcr-v2-decay`; tmux `h4k_lfcr_v2_decay_20260528_091455`; log `experiment/HAZE4K/_run_logs/DEA-Net-LFCR-v2-decay-H4K-scout100k-20260528-091455.log`; fair config keeps LF-v1 plus `w_loss_crplus_v2=0.005` through step `10000`, linearly decays to `0.0` by step `20000`, then disables CRPlus-v2; do not sync checkpoints unless explicitly requested; first artifact checks are 10k/20k/30k gates | `KEEP_MINIMAL_REMOTE_MODEL` |
