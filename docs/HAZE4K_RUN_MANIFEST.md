...
| `DEA-Net-CRPlusV2-w003-H4K-scout100k-20260526-192721` | active | active local fair scout | TBD | branch/commit `codex/haze4k-crplus-v2` / `2e0987c`; local WSL run because cloud server is unavailable; tmux `h4k_crplusv2_100k_20260526-192721`; log `experiment/HAZE4K/_run_logs/DEA-Net-CRPlusV2-w003-H4K-scout100k-20260526-192721.log`; fair config with `w_loss_crplus_v2=0.003`; startup reached step `17/100000`, GPU about `15975 MiB / 99%`; first 10k gate pending | `KEEP_MINIMAL` |
