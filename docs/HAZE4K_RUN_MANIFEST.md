...
| `DEA-Net-LF-v2-MBR-c8-H4K-scout100k-20260528-223014` | active remote | active LF-v2 MBR fair scout | no checkpoint yet; first gate 10k | launched on `runyun-ts` from `/root/workspace/Dehaze-Net-audit-sync`, branch/commit `codex/haze4k-lf-v2-mbr` / `cc6b3c4`, after preflight passed; fair protocol `epochs=20`, `iters_per_epoch=5000`, total `100000`, `bs=16`, `patch_size=256`, `w_loss_CR=0.1`, checkpoint/eval every `10000`, `save_epoch_checkpoints=false`, flags `--use_lf_prior --lf_multiscale_refiner --lf_mbr_channels 8 --lf_mbr_pool_sizes 4,8,16`; log `experiment/HAZE4K/_run_logs/DEA-Net-LF-v2-MBR-c8-H4K-scout100k-20260528-223014.log`; first hard route gate is 30k | `KEEP_ACTIVE_REMOTE_MODEL` |
| `DEA-Net-LF-v2-MBR-c8-H4K-scout100k-autodl-20260529-144500` | active remote | active AutoDL LF-v2 MBR fair scout restarted from scratch | no checkpoint yet; first gate 10k | launched on `autodl-dehaze` from `/root/autodl-tmp/workspace/Dehaze-Net`, branch/commit `codex/haze4k-lf-v2-mbr` / `966d041`, after AutoDL preflight passed; fair protocol `epochs=20`, `iters_per_epoch=5000`, total `100000`, `bs=16`, `patch_size=256`, `w_loss_CR=0.1`, checkpoint/eval every `10000`, `save_epoch_checkpoints=false`, flags `--use_lf_prior --lf_multiscale_refiner --lf_mbr_channels 8 --lf_mbr_pool_sizes 4,8,16`; log `experiment/HAZE4K/_run_logs/DEA-Net-LF-v2-MBR-c8-H4K-scout100k-autodl-20260529-144500.log`; first hard route gate is 30k | `KEEP_ACTIVE_REMOTE_MODEL` |
