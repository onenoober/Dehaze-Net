...
| Strong-official depth safety audit | `docs/HAZE4K_STRONG_OFFICIAL_DEPTH_SAFETY_AUDIT_20260530.md` | Stage 0 diagnostic route card：只验证 predicted depth 是否能比 basic image stats 更稳定地降低 strong-official/no-change false intervention；不授权训练。 |
