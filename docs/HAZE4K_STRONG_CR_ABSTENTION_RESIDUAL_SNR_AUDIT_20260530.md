...
Status: proposed diagnostic audit only. This card authorizes an AutoDL
abstention and residual-SNR audit using existing checkpoints and compact
artifacts. It does not authorize a new model implementation or any 100k
training run.
