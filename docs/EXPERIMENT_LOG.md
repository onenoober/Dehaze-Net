...
| 2026-05-20 | codex/haze4k-training-plan | HAZE4K | DEA-Net-CR | baseline scouting train | running; step 10000 PSNR 27.1101 / SSIM 0.9615 | run `DEA-Net-CR-H4K-Baseline-scout-20260520-101334`; target 100k steps; `bs=16`, `patch_size=256`, `w_loss_CR=0.1`; first checkpoint `best.pk`/`latest.pk` saved |
