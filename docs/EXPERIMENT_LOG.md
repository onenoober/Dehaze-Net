...
| 2026-05-21 | codex/haze4k-lf-prior | HAZE4K | DEA-Net-LF | lightweight LF prior scout | running | run `DEA-Net-LF-H4K-scout-20260521-003100`; tmux `h4k_lf_scout_20260521_003100`; code commit `857661d`; `bs=16`, `patch_size=256`, `epochs=20`, `iters_per_epoch=5000`, `use_lf_prior=true`, `lf_prior_channels=8`, `lf_prior_pool=8`, `lf_prior_gate_init=0.0`, `w_loss_CR=0.1`; launcher log `experiment/HAZE4K/_run_logs/DEA-Net-LF-H4K-scout-20260521-003100.log`; first validation expected at step 10000 |
